...
A highly scalable GitHub App that acts as a central receiver of GitHub events and distributes them to multiple downstream subscribers. Built for large GitHub Enterprise environments.
...
- **Database:** Store subscriber configuration, event audit, and delivery tracking (PostgreSQL, SQLite)
